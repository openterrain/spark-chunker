...
# SPOT_WORKER_COUNT=1
SPOT_WORKER_COUNT=10

aws s3 cp emr.json s3://emr.openterrain.org/ned/ --acl public-read
aws s3 cp bootstrap.sh s3://emr.openterrain.org/ned/ --acl public-read
aws s3 cp ../chunk.py s3://emr.openterrain.org/ned/ --acl public-read
aws s3 cp ../pyramid.py s3://emr.openterrain.org/ned/ --acl public-read
